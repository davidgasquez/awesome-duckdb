...
DuckDB 1.1.0 was released on 2024-09-09: see the [announcement blog post](https://duckdb.org/2024/09/09/announcing-duckdb-110).
...
- [SQLFlite - Arrow Flight SQL Server](https://github.com/voltrondata/sqlflite) - An example implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) what runs in a client-server setup with DuckDB or SQLite as backends.
